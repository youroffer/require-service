		...
		case '/': // Prefix: "/v1/"
			...
			case 'a': // Prefix: "a"
				...
				case 'n': // Prefix: "nalytics/"
					...
					case '/': // Prefix: "/limit"
						origElem := elem
						if l := len("/limit"); len(elem) >= l && elem[0:l] == "/limit" {
							elem = elem[l:]
						} else {
							break
						}
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleV1AnalyticsAnalyticIDLimitGetRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
				...
				case 'n': // Prefix: "nalytics/"
					...
					case '/': // Prefix: "/limit"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = "V1AnalyticsAnalyticIDLimitGet"
								r.summary = "Получить аналитику по ID с ограничениями"
								r.operationID = ""
								r.pathPattern = "/v1/analytics/{analyticID}/limit"
								r.args = args
								r.count = 1
								return r, true
							default:
